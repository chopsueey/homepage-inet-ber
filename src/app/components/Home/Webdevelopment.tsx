...
export default function Webdevelopment() {
  ...
  return (
    <section className="container mx-auto max-w-screen-2xl p-4 py-10 dark:bg-blue-600 bg-blue-600 rounded-3xl my-8 shadow-lg">
      <div className="flex flex-col items-center overflow-x-hidden px-4 pb-10 lg:flex-row lg:justify-between lg:px-32">
        <div className="mb-6 mt-8 flex flex-col justify-start lg:items-end">
          ...
          <h1
            className="relative text-center text-4xl font-bold xl:left-16 text-white"
            data-aos="fade-left"
            data-aos-delay="500"
          >
            Wir helfen dir.
      ...
      <div
      // text-gray-600
        className="prose mx-auto px-5 text-center text-white dark:text-white"
        data-aos="fade-up"
        data-aos-delay="100"
      >
        <p>
